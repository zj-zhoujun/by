...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
        #ta{width:90%;height:350px;margin:20px;margin-top:90px;font-size: 80%;border:1px solid #ccc;}
...
<div class="page">
    ...
    <header class="bar bar-nav">
        ...
        <a style="position: absolute;z-index: 19;width: 94%;text-align: center;display: inline-block;line-height: 50px;font-size: 1.1rem; color:#FFF;">推广文案</a>    <div class="logo">
    ...
    <nav class="foot-bar">
        ...
        <textarea id="ta"  ><?php echo ($adurl2); ?></textarea>


    <span id="tjbd_text"><a class="button button-big button-fill button-success js-tixian-submit" onclick="jsCopy()" >复制</a></span>
</div>
