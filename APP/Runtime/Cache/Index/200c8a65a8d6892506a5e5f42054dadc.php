...
<div class="content" id="main_content">
    <div class="buttons-tab">
        ...
        <a href="<?php echo U('Index/Account/dlmm');?>" class="active button">修改收款码</a>
...
<form method="post" action="<?php echo U('Account/dlmmpost1');?>" id="formid" enctype="multipart/form-data" data-ajax="false">
    <div class="exchange">
        <ul class="mui-table-view">
            <li class="mui-table-view-cell">
                <div class="assets">
                    ...
                    <div>
                        <?php if($status == 1): ?>可修改<?php else: ?><font color="red">已审核</font><?php endif; ?>
                        </div>
                </div></li>
            <li class="mui-table-view-cell">
                <div class="assets">
                    ...
                    <div>
                            <font color="red"> <?php echo ($list["shenfen"]); ?></font>
                    </div>
                </div></li>
            <li class="mui-table-view-cell">
                <div class="assets">
                    ...
                    <div>
                        <font color="red">  <?php echo ($list["truename"]); ?></font>
                        </div>
                </div></li>
        </ul>
                    </div>
    ...
    <?php if($status == 1): ?><div class="subMessage">
