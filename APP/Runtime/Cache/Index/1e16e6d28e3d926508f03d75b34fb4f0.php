...
<div class="page">
    ...
    <div class="content" id="main_content">
        <div class="buttons-tab">
            <a href="<?php echo U('Financial/keshou');?>" class="active button">可售余额</a>

            <a href="<?php echo U('Financial/kcqb');?>" class=" button">矿池钱包</a>
            <a href="<?php echo U('Financial/kczc');?>" class=" button">矿池资产</a>
            <a href="<?php echo U('Financial/djks');?>" class=" button">冻结可售</a>
        </div>
        <div class="tabs">
            <br>
            <h4 style="color: #333333; font-size:18px;">可售余额明细</h4>
