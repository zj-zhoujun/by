...
<div class="content" id="main_content">
    ...
    <h4 style="color: #333333; font-size:18px;">可售余额兑换矿池钱包</h4>
    <hr color="#333333" size="1">
    <div class="list-block">
        <form class="cmxform form-horizontal tasi-form" name="form1" id="form1" method="post" action="<?php echo U('Account/dhpost');?>">
            <ul>
                <li>
                    <div class="item-content">
                        <div class="item-media"><i class="icon icon-form-name"></i></div>
                        <div class="item-inner">
                            <div class="item-title label">可售余额</div>
                            <div class="item-input">
                                <?php echo (four_number($ksye["ksye"])); ?>枚
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    <div class="item-content">
                        ...
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input id="zchb" name="zchb" type="text" value="" placeholder="<?php echo ($dhzcbs); ?>起<?php echo ($dhzcbs); ?>的倍数" style="font-size:16px;">
                            </div>
                        </div>
                    </div>
                </li>
    ...
    <div class="content-block">
        <div class="row">
            ...
            <div class="col-50"><a onclick="document.getElementById('form1').submit();" id="submit" class="button button-big button-fill button-success js-tixian-submit">确认兑换</a></div>
