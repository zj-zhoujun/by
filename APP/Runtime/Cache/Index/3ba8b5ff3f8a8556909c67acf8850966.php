...
<div class="content" id="main_content">
	...
	<div class="buttons-tab">
		<a href="<?php echo U('Index/Shop/orderlist');?>" class="active button">正常矿机</a>
		...
		<div class="card">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" id="table-5">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td align="center" valign="middle"><?php echo ($vo["project"]); ?><br>
						预计<?php echo ($vo["kjsl"]); ?>/小时</td>
...
<?php if($kjnum != 0): ?><span><a class="button button-big button-fill button-success js-tixian-submit" href="<?php echo U('Shop/jiesuan');?>">一键领取</a></span><?php endif; ?>
