...
<!-- saved from url=(0056)http://www.xxx.com/home/index/newspage/id/240.html -->
...
<div class="page">
	...
	<header class="bar bar-nav">
		...
		<a style="position: absolute;z-index: 19;width: 94%;text-align: center;display: inline-block;line-height: 50px;font-size: 1.1rem; color:#FFF;">公告详细</a>    <div class="logo">
	...
	<div class="content" id="main_content">
		...
		<div class="card-header" style="background:#FFF; text-align:center; font-size:16px;"><?php echo ($new["title"]); ?>-<?php echo (date("Y-m-d",$new["addtime"])); ?></div>
		<div class=" news-content" style="font-size:12px;">
			<p style="text-indent:32px">
				<span style="font-size: 16px; font-family: 微软雅黑, &quot;Microsoft YaHei&quot;;"><?php echo (stripcslashes($new["content"])); ?></span>
			</p>
