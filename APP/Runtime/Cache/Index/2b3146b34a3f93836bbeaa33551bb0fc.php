...
<header class="bar bar-nav">
    ...
    <a style="position: absolute;z-index: 19;width: 94%;text-align: center;display: inline-block;line-height: 50px;font-size: 1.1rem; color:#FFF;">修改登录密码</a>    <div class="logo">
...
<div class="content" id="main_content">
    <div class="buttons-tab">
		...
		<a href="<?php echo U('Index/Account/xgmm');?>" class="active button">修改密码</a>
    ...
    <div class="list-block">
        <form class="cmxform form-horizontal tasi-form" action="<?php echo U('Index/Account/dlmmpost');?>" name="xgmm" id="xgmm" method="post">
            <ul>
                <li>
                    <div class="item-content">
                        ...
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input class="col-20" type="password" placeholder="请输入原密码" name="old_password" value="">
                            </div>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="item-content">
                        ...
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input class="col-20" type="password" placeholder="请输入新密码" name="newpwd" value="">
                            </div>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="item-content">
                        ...
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input class="col-20" type="password" placeholder="请确认新密码" name="newpwd1" value="">
                            </div>
                        </div>
                    </div>
                </li>
    ...
    <div class="content-block">
        <div class="row">
            ...
            <div class="col-50"><a href="<?php echo U('Index/Account/xgmm');?>" class="button button-big button-fill button-dark">取消</a></div>
        </div>
    </div>
