							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								<thead>
									<tr>
										...
										<th>手机号码</th>
										<th>推荐人</th>
										<th><a href="<?php echo U('systemlogined/Member/check',array('_order'=>'ztnum','_sort'=>0));?>">直推人数↑</a></th>
										<th><a href="<?php echo U('systemlogined/Member/check',array('_order'=>'tdnum','_sort'=>0));?>">团队人数↑</a></th>
										...
										<th><a href="<?php echo U('systemlogined/Member/check',array('_order'=>'jinbi','_sort'=>0));?>">矿池钱包↑</a></th>
										<th><a href="<?php echo U('systemlogined/Member/check',array('_order'=>'kczc','_sort'=>0));?>">矿池资产↑</a></th>
										<th><a href="<?php echo U('systemlogined/Member/check',array('_order'=>'ksye','_sort'=>0));?>">可售余额↑</a></th>
										<th><a href="<?php echo U('systemlogined/Member/check',array('_order'=>'ksed','_sort'=>0));?>">可售额度↑</a></th>
										<th><a href="<?php echo U('systemlogined/Member/check',array('_order'=>'qjinbi','_sort'=>0));?>">交易冻结↑</a></th>
										<th><a href="<?php echo U('systemlogined/Member/check',array('_order'=>'status','_sort'=>0));?>">实名↑</a></th>
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
											...
											<td><a href="<?php echo U('Member/check',array('pid'=>$v['id']));?>"><?php echo ($v["ztnum"]); ?></a></td>
											<td><?php echo ($v["tdnum"]); ?></td>
											<td><?php echo (date('Y-m-d H:i',$v["regdate"])); ?></td>

											<td><?php echo ($v["mygonglv"]); ?></td>
											<td><?php echo ($v["teamgonglv"]); ?></td>
											<td><?php echo ($v["jinbi"]); ?></td>
											<td><?php echo ($v["kczc"]); ?></td>
											<td><?php echo ($v["ksye"]); ?></td>
											<td><?php echo ($v["ksed"]); ?></td>
											<td><?php echo ($v["qjinbi"]); ?></td>
											<td>
												<?php if($v["status"] == 1): ?><font color="red">已实名</font>
													<?php else: ?>
													<font color="#4169e1">未实名</font><?php endif; ?>
											</td>
											<td>
											...
											<td><?php if($v["lock"] == 1): ?><a onclick="if(confirm('确认解封此账户吗?')==false)return false;" href="<?php echo U(GROUP_NAME .'/Member/editFeng',array('id'=>$v['id'],'lock'=>0));?>">解封</a>
												...
												<td><?php if($v['status'] == 2): ?><a href="<?php echo U('systemlogined/Member/check',array('status'=>$v['status'],'id'=>$v['id']));?>">需要上传款码</a><?php else: ?>不需要上传款码<?php endif; ?></td>
