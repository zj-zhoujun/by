				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						...
						<form id="table-searchbar" method="get" class="form-inline well well-small">
							<div class="row-fluid">&nbsp;&nbsp;投诉订单ID
				                <input type="text" class="input-small" name="ppdd_id" value="<?php echo $_GET['ppdd_id'];?>">    
		                        &nbsp;&nbsp;
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
										<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                            <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['user']));?>"><?php echo ($v["user"]); ?></a></td>
                                            <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['user']));?>"><?php echo ($v["user_id"]); ?></a></td>
                                            <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['buser']));?>"><?php echo ($v["buser"]); ?></a></td>
                                            <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['buser']));?>"><?php echo ($v["buser_id"]); ?></a></td>
                                            <td><?php echo ($v["text"]); ?></td>
                                            <td><?php echo ($v["date"]); ?></td>
                                            <td><a href="<?php echo U('Jinbidetail/jiaoyi',array('id'=>$v['pid']));?>"><?php echo ($v["pid"]); ?></a></td>
