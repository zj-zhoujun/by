							...
							<div class="span7 infobox-container" style="width:90%;">
								...
								<div class="infobox infobox-orange2  ">
									...
									<div class="infobox-data">
										...
										<div class="infobox-content">当前矿机总数</div>
									</div>
								</div>
                               ...
                               <div class="infobox infobox-red  ">
                                 ...
                                 <div class="infobox infobox-orange2  ">
									...
									<div class="infobox-data">
										<span class="infobox-data-number"><?php echo (set_number($data_c,4)); ?></span>
										<div class="infobox-content">当前可售额度总和</div>
									</div>
								</div>
                                ...
                                <div class="infobox infobox-red  ">
									...
									<div class="infobox-data">
										...
										<div class="infobox-content">当前可售余额总和</div>
									</div>
								</div>
								<div class="infobox infobox-red  ">
									<div class="infobox-icon">
									...
									<div class="infobox-data">
										<span class="infobox-data-number"><?php echo (set_number($data_g,4)); ?></span>
										<div class="infobox-content">当前冻结交易总和</div>
									</div>
								</div>
                               ...
                               <div class="infobox infobox-red  ">
									...
									<div class="infobox-data">
										...
										<div class="infobox-content">当前矿池资产总和</div>
									</div>
								</div>
