				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounce"  action="<?php echo U(GROUP_NAME.'/Info/addAnnounceHandle');?>" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="radio" value="all" checked="checked" name="viewer">
										<span class="lbl"> 所有</span>

										<input type="radio" value="member" name="viewer">
										<span class="lbl"> 会员</span>

										<input type="radio" value="center" name="viewer">
