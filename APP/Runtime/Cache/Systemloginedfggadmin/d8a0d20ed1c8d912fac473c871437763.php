...
<script type="text/javascript">
	$(function() {
				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="editGroupHandle"  action="<?php echo U(GROUP_NAME .'/Member/editGroupHandle');?>" method="post">
							  <input type="hidden" name="groupid" value="<?php echo ($member_group["groupid"]); ?>">
								<div class="control-group">
									<label class="control-label" for="name"> 会员组名称</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["name"]); ?>" name="name" id="name"  placeholder="" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="tjjnum"> 直推人数</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["tjjnum"]); ?>" name="tjjnum" id="tjjnum"  placeholder="" />
									</div>
								</div>
								
								<div class="control-group">
									<label class="control-label" for="teamnum"> 团队人数</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["teamnum"]); ?>" name="teamnum" id="teamnum"  placeholder="" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<label class="control-label" for="shouxu"> 交易手续费</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["shouxu"]); ?>" name="shouxu" id="shouxu"  placeholder="" />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="ldj"> 推广代数奖励</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["ldj"]); ?>" name="ldj" id="ldj"  placeholder="" />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="jfnum"> 解封数量</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["jfnum"]); ?>" name="jfnum" id="jfnum"  placeholder="" />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="sfbl"> 每天释放比例</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["sfbl"]); ?>" name="sfbl" id="sfbl"  placeholder="" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sfbl"> 溢价比例</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["yjbl"]); ?>" name="yjbl" id="yjbl"  placeholder="" />
									</div>
								</div>
								...
								<!-- 新加 -->
								<div class="control-group">
									<label class="control-label" for="sfbl"> 买入时间限制</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["item1"]); ?>" name="item1" id="item1"  placeholder="" /><span style="color:red;">买入时间限制设置格式案例: 00:00-24:00</span>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sfbl"> 每天出售单数</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["item2"]); ?>" name="item2" id="item2"  placeholder="" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sfbl"> 修改资料扣费</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["item3"]); ?>" name="item3" id="item3"  placeholder="" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sfbl"> 升级奖钱包</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["item4"]); ?>" name="item4" id="item4"  placeholder="" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sfbl"> 升级奖资产</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["item5"]); ?>" name="item5" id="item5"  placeholder="" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sfbl"> 升级奖励矿机</label>

									<div class="controls">
									    <select name="item6" id="item6">
									        <option value="2" <?php if($member_group['item6'] == 2): ?>selected<?php endif; ?>>微型矿机</option>
									        <option value="3" <?php if($member_group['item6'] == 3): ?>selected<?php endif; ?>>小型矿机</option>
									        <option value="4" <?php if($member_group['item6'] == 4): ?>selected<?php endif; ?>>中型矿机</option>
									        <option value="5" <?php if($member_group['item6'] == 5): ?>selected<?php endif; ?>>大型矿机</option>
									        <option value="6" <?php if($member_group['item6'] == 6): ?>selected<?php endif; ?>>超级矿机</option>
									    </select>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="sfbl"> 奖励数量</label>

									<div class="controls">
										<input type="text" value="<?php echo ($member_group["item7"]); ?>" name="item7" id="item7"  placeholder="" />
									</div>
								</div>
		...
		<!--basic scripts-->
		<script type='text/javascript'>
			var checkGroupName = "<?php echo U(GROUP_NAME.'/Member/checkGroupName');?>";
		</script>
		...
		<script type="text/javascript">
		$('form[name="editGroupHandle"]').validate({
					//默认为lable
					errorElement : 'span',
					//失败时先移除成功的class
					validClass : 'success',
