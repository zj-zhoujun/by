				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						...
						<form id="table-searchbar" method="POST" class="form-inline well well-small">
							<div class="row-fluid">&nbsp;&nbsp;用户手机号 
				                <input type="text" class="input-small" name="user" value="<?php echo $_POST['user'];?>">    
		                        &nbsp;&nbsp;
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
										<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
										 ...
										 <td><?php echo ($v["id"]); ?></td>
										 <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['mr_user']));?>"><?php echo ($v["mr_user"]); ?></a></td>
										<td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['mr_user']));?>"><?php echo ($v["mr_id"]); ?></a></td>
										<td><?php echo group($v[mr_level]);?>
										</td>
										<td><?php echo ($v["cbt"]); ?></td>
										<td><?php echo ($v["danjia"]); ?>$</td>
										<td><?php echo ($v["qian"]); ?>$</td>
										<td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['mc_user']));?>"><?php echo ($v["mc_user"]); ?></a></td>
										<td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['mc_user']));?>"><?php echo ($v["mc_id"]); ?></a></td>
										<td><?php echo group($v[mc_level]);?>
										</td>
										<td><?php echo ($v["jydate"]); ?></td>
										<td><a href="<?php echo ($v["imagepath"]); ?>" target="_blank"><img src="<?php echo ($v["image"]); ?>"  style="width:40px;"/></a></td>
								
									<!--	<td><a href="<?php echo U('jinbidetail/jywcdel',array('id'=>$v['id']));?>" class="tablelink">删除</a></td>-->
										</tr><?php endforeach; endif; ?>
									<tr>
										<td colspan="12" style="text-align:center;"><div class="page"><?php echo ($page); ?></div></td>
									</tr>
								</tbody>
							</table>
						</div>
